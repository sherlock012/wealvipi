<?php
$windows = allvipi_get_fields('wood-windows');

$doors = allvipi_get_fields('wood-doors');

$projects = allvipi_get_fields('wood-projects');
    ...
    <main>
        ...
        <div class="default-page classification-page" data-aos="fade-in" id="second-page">
            <div class="container header">
                <header>
                    Деревянные <span class="classification-windows">окна</span><span class="classification-doors hide">двери</span>
                </header>
            ...
            <div class="container about-us">
                <div class="company-row-wrapper">
                    <div class="company-row">
                        ...
                        <div class="caption">
                            <b>WE ALVIPI</b> Является ведущим специалистом в области разработки и маркетинга инновационных,
        ...
        <div class="default-page premium-page" data-aos="fade-in" id="forth-page">
            ...
            <div class="container">
                <div class="premium-page-content">
                    ...
                    <div class="premium-page--picture premium-page--picture-wood" id="premium-profile">
        ...
        <div class="default-page leave-request-page">
            <div class="container leave-request">
                ...
                <div class="leave-request--left">
                    <figure class="figure form-bg-wood"></figure>
                </div>
            </div>
        </div>
